...
enum bno055_sensor_channel {
    ...
    SENSOR_CHAN_QUADTERNION_W       = SENSOR_CHAN_PRIV_START + 4,
    SENSOR_CHAN_QUADTERNION_X       = SENSOR_CHAN_PRIV_START + 5,
    SENSOR_CHAN_QUADTERNION_Y       = SENSOR_CHAN_PRIV_START + 6,
    SENSOR_CHAN_QUADTERNION_Z       = SENSOR_CHAN_PRIV_START + 7,
    SENSOR_CHAN_QUADTERNION_WXYZ    = SENSOR_CHAN_PRIV_START + 8,
