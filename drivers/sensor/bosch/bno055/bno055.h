...
#define SENSOR_CHAN_EULER_H     SENSOR_CHAN_PRIV_START
#define SENSOR_CHAN_EULER_R     SENSOR_CHAN_EULER_H + 1
#define SENSOR_CHAN_EULER_P     SENSOR_CHAN_EULER_R + 1
#define SENSOR_CHAN_EULER_HRP   SENSOR_CHAN_EULER_P + 1

#define SENSOR_CHAN_QUADTERNION_W       SENSOR_CHAN_EULER_HRP + 1
#define SENSOR_CHAN_QUADTERNION_X       SENSOR_CHAN_QUADTERNION_W + 1
#define SENSOR_CHAN_QUADTERNION_Y       SENSOR_CHAN_QUADTERNION_X + 1
#define SENSOR_CHAN_QUADTERNION_Z       SENSOR_CHAN_QUADTERNION_Y + 1
#define SENSOR_CHAN_QUADTERNION_WXYZ    SENSOR_CHAN_QUADTERNION_Z + 1

#define SENSOR_CHAN_LINEAR_ACCEL_X      SENSOR_CHAN_QUADTERNION_WXYZ + 1
#define SENSOR_CHAN_LINEAR_ACCEL_Y      SENSOR_CHAN_LINEAR_ACCEL_X + 1
#define SENSOR_CHAN_LINEAR_ACCEL_Z      SENSOR_CHAN_LINEAR_ACCEL_Y + 1
#define SENSOR_CHAN_LINEAR_ACCEL_XYZ    SENSOR_CHAN_LINEAR_ACCEL_Z + 1

#define SENSOR_CHAN_GRAVITY_X   SENSOR_CHAN_LINEAR_ACCEL_XYZ + 1
#define SENSOR_CHAN_GRAVITY_Y   SENSOR_CHAN_GRAVITY_X + 1
#define SENSOR_CHAN_GRAVITY_Z   SENSOR_CHAN_GRAVITY_Y + 1
#define SENSOR_CHAN_GRAVITY_XYZ SENSOR_CHAN_GRAVITY_Z + 1

#define SENSOR_CHAN_CALIBRATION_A       SENSOR_CHAN_GRAVITY_XYZ + 1
#define SENSOR_CHAN_CALIBRATION_B       SENSOR_CHAN_CALIBRATION_A + 1
#define SENSOR_CHAN_CALIBRATION_C       SENSOR_CHAN_CALIBRATION_B + 1
#define SENSOR_CHAN_CALIBRATION_D       SENSOR_CHAN_CALIBRATION_C + 1
#define SENSOR_CHAN_CALIBRATION_ABCD    SENSOR_CHAN_CALIBRATION_D + 1
